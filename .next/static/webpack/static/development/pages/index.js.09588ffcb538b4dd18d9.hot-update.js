...
function RSVPPersonal(props) {
  ...
  return __jsx("form", {
    ...
    __self: this
  }, numberSID.name, "\" name=", numberSID.name, "ref=", register({
    required: 'No SID/AKSes.KSEI is required',
    minLength: {
      value: 6,
      message: "Minimum 6 length is required"
    }
  }), "type=\"text\" className=\"form-control\" />", __jsx(react_hook_form__WEBPACK_IMPORTED_MODULE_1__["ErrorMessage"], {
    as: "p",
    errors: errors,
    name: numberSID.name,
    __source: {
...
//# sourceMappingURL=index.js.09588ffcb538b4dd18d9.hot-update.js.map